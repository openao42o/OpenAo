...
class CGLogDataAceConcurrentUser : public CGLogDataBase
{
public:
	CGLogDataAceConcurrentUser(_RecordsetPtr i_pSourceRecordSet,_CommandPtr i_pSourceCommand,_RecordsetPtr i_pDestRecordSet,_CommandPtr i_pDestCommand);
	~CGLogDataAceConcurrentUser(void);
...
private:
	...
	CAceConcurrentUserData	m_arrAceConcurrentUserData[GLOG_DATA_MAX_CNT];
};
