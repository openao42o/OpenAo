...
public:
	...
	CGLogDataAccount(_RecordsetPtr i_pSourceRecordSet,_CommandPtr i_pSourceCommand,_RecordsetPtr i_pDestRecordSet,_CommandPtr i_pDestCommand);
	~CGLogDataAccount(void);
...
private:
	...
	CAccountData	m_arrAccountData[GLOG_DATA_MAX_CNT];
};
