...
class CGLogDataCharacterPlayTime :
	public CGLogDataBase
{
public:
	CGLogDataCharacterPlayTime(_RecordsetPtr i_pSourceRecordSet,_CommandPtr i_pSourceCommand,_RecordsetPtr i_pDestRecordSet,_CommandPtr i_pDestCommand);
	~CGLogDataCharacterPlayTime(void);
...
private:
	...
	CCharacterPlayTimeData	m_arrCharacterPlayTimeData[GLOG_DATA_MAX_CNT];
};
