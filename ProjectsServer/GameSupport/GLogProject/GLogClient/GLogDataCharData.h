...
class CGLogDataCharData :	public CGLogDataBase
{
public:
	CGLogDataCharData(_RecordsetPtr i_pSourceRecordSet,_CommandPtr i_pSourceCommand,_RecordsetPtr i_pDestRecordSet,_CommandPtr i_pDestCommand);
	~CGLogDataCharData(void);
...
private:
	...
	CCharData	m_arrCharData[GLOG_DATA_MAX_CNT];
};
