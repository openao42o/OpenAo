...
class CGLogDataAceUser : public CGLogDataBase
{
public:
	CGLogDataAceUser(_RecordsetPtr i_pSourceRecordSet,_CommandPtr i_pSourceCommand,_RecordsetPtr i_pDestRecordSet,_CommandPtr i_pDestCommand);
	~CGLogDataAceUser(void);
...
private:
	...
	CAceUserData	m_arrAceUserData[GLOG_DATA_MAX_CNT];
};
