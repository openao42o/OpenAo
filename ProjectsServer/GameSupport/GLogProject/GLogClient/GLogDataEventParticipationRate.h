...
class CGLogDataEventParticipationRate :
	public CGLogDataBase
{
public:
	CGLogDataEventParticipationRate(_RecordsetPtr i_pSourceRecordSet,_CommandPtr i_pSourceCommand,_RecordsetPtr i_pDestRecordSet,_CommandPtr i_pDestCommand);
	~CGLogDataEventParticipationRate(void);
...
private:
	...
	CEventParticipationRateData	m_arrEventParticipationRateData[GLOG_DATA_MAX_CNT];
};
