...
protected:	
	...
	DECLARE_MESSAGE_MAP()
private:
	int			m_nSelItem;	// 한개 선택한 아이템

	BOOL		m_bColumnEdit[MAX_COLUMN];

public:
	void		SetColumnEditEnable(const int nColumnIndex, const BOOL bEnable)
	{
		m_bColumnEdit[nColumnIndex]	= bEnable;
	}
};
