...
VOID DIDCfgView::CleanUp()
{
    ...
    {
        // free array
        util::del_array( m_lpDidImgHeader->lprgImageInfoArray );
    ...
    util::del( m_lpViewManager );

    // free callout manager
    util::del( m_lpCalloutManager );

    // free the custom view info
    util::del( m_lpCustomViewInfo );
    ...
    if( m_lpDiaf )
    {
        ...
        util::del_array( m_lpDiaf->rgoAction );
