...
namespace Formatter
{
    ...
    public class Struct
    {
        ...
        public virtual void Write(Stream dest, object[] value)
        {
            ...
            for (var i = 0; i < value.Length; i++) Fields[i].Write(buffer, Fields[i].Offset, value[i]);
        ...
        public void WriteMany(Stream dest, IEnumerable<object[]> value)
        {
            foreach (var v in value) Write(dest, v);
        }
    ...
    public static class ObjectInfoFormatter
    {
        ...
        class BodyCondFormatter : Struct
        {
            ...
            public override void Write(Stream dest, object[] value)
            {
                ...
                formatters[2].WriteMany(dest, value[1] as object[][]);
            }
        }
        ...
        public static void Write(Stream dest, object[] value)
        {
            ...
            formatters[1].WriteMany(dest, value[1] as object[][]);
        }
