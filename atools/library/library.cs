...
namespace Library
{
    ...
    public static class Extensions
    {
        ...
        /// <summary> Like IEnumerable<T>.Where(predicate).First()
        /// Throws ArgumentException if there is not exactly 1 element
        /// </summary>
        public static T Unique<T>(this IEnumerable<T> collection, Func<T, bool> predicate)
        {
            var temp = collection.Where(predicate);
            
            if (temp.Count() != 1) throw new IndexOutOfRangeException();
    ...
    public class DataTableEx : DataTable
    {
        ...
        public DataRowEx this[int idx]
        {
            get { return (DataRowEx)Rows[idx]; }
        }
        ...
        public void Add(object[] value, object tag)
        {
            var row = NewRow();
            row.ItemArray = value;
            row.Tag = tag;
...
namespace AtumZip
{
    ...
    public static class FileTypes
    {
        ...
        {
            foreach (var pair in extensions) if (pair.Key == Code) return pair.Value;
        ...
        public static string FindType(byte[] Item)
        {
            ...
            return FindType(BitConverter.ToUInt32(Item, 0));
        }
        ...
        public static string FindType(byte[] Item, int Index)
        {
            ...
            return FindType(BitConverter.ToUInt32(Item, Index));
        }
        ...
        public static string FindType(Stream Stream)
        {
            ...
            return FindType(Stream.Read<uint>());
        }
    }
    ...
    public class Item
    {
        ...
        public string Extension { get { return FileTypes.FindType(Data); } }
    }
    ...
    public class FileHeader
    {
        ...
        public bool Valid { get { return magicA == Magic && magicB == Magic; } }
