...
#define HSERROR_HSUPDATE_MODIFICATION			( HACKSHIELD_ERROR + 0x91 )
...
// Option for Running Mode
#define	AHNHSUPDATE_RUN_WOW64					0x1
#define	AHNHSUPDATE_RUN_32						0x2
#define	AHNHSUPDATE_RUN_64						0x4
...
#define	 _AhnHS_HSUpdate(arg1,arg2,arg3,arg4)					HACKSHIELD_ERROR_SUCCESS
#define	 _AhnHS_HSUpdateEx(arg1,arg2,arg3,arg4,arg5,arg6,arg7)	HACKSHIELD_ERROR_SUCCESS
...
DWORD
 __stdcall
 _AhnHS_HSUpdateA ( 
	IN LPCSTR	szUpdateDir, 
	IN DWORD	dwTimeOut, 
	IN DWORD	dwTimeOutPerConnection = 0,
	IN DWORD	dwRunnnigMode = 0
	);

DWORD
 __stdcall
 _AhnHS_HSUpdateW ( 
	IN LPCWSTR	szUpdateDir, 
	IN DWORD	dwTimeOut,
	IN DWORD	dwTimeOutPerConnection = 0,
	IN DWORD	dwRunnnigMode = 0
	);
