...
#ifndef COMMON_DBGOUT_S_H_
#define COMMON_DBGOUT_S_H_

static  LPCTSTR    g_dbgOut                = _T("Server DebugOutput 20020805");
static  LPCTSTR    g_dbgOutwindowClassName = _T("Server DebugOut Window");
