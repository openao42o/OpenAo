...
#ifndef COMMON_DBGOUT_AUTHENTICATION_H_
#define COMMON_DBGOUT_AUTHENTICATION_H_

static  LPCTSTR    g_dbgOut                = _T("Authentication Server 20110126");
static  LPCTSTR    g_dbgOutwindowClassName = _T("Authentication DebugOut Window");
...
#endif // COMMON_DBGOUT_AUTHENTICATION_H_
