...
// 2009-09-16 by cmkwon, 세력 초기화시 어뷰징 방지 구현 - 위치 이동
...
public:
	...
	// 2009-01-28 by cmkwon, 캐쉬샾 수정(추천탭,신상품 추가) - public 으로 이동함.
...
protected:
	...
	// 2013-02-05 by bckim, 캐시샵 추천탭 정렬순서부여 - 접근권한 수정 protected: -> public:
public:
