...
#ifndef COMMON_DBGOUT_LOG_H_
#define COMMON_DBGOUT_LOG_H_

static  LPCTSTR    g_dbgOut                = _T("Log Server 20021017");
static  LPCTSTR    g_dbgOutwindowClassName = _T("Log DebugOut Window");
