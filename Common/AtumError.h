...
#define ERR_PROTOCOL_NO_SUCH_SHOP						0x2456		// 해당 事?없음
#define ERR_PROTOCOL_NO_SUCH_SHOP_ITEM					0x2457		// 乍【 해당 아이템을 팔지 않음
...
#define ERR_CASH_INVALID_GIVE_TARGET_ACCOUNT			0x3009		// 2009-08-18 by cmkwon, 예당 캐쉬?블럭 계정 체크 추가 - 계정 블럭 상태
