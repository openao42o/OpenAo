...
BOOL StringCullingUserDataEx(char *pLineString, int nCullStringNum, vector<string> *vecStorage, CD3DHanFont* pHanFont, BOOL bChRt = FALSE, BOOL bShop = FALSE);        // 2013-04-05 by ssjung ?일때 아이템 이름 글자 수 넘어 갈때 처리 보정
