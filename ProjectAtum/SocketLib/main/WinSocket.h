...
public:
	...
	BOOL Connect(LPCSTR strPeerIP, int nPort);					// Client로서 동작, Server 로 연결시도
	...
	inline BOOL Write(BYTE *pPacket, int nLength) { return Write((LPCSTR)pPacket, nLength); }	// BYTE* 전송용
