...
//-----------------------------------------------------------------------------
//#ifndef util::del
//template<typename ptr_t> inline void util::del(ptr_t*& p) { if (p) { delete p; p = nullptr; } }
//#endif
//
//#ifndef util::del_array
//template<typename ptr_t> inline void util::del_array(ptr_t*& p) { if (p) { delete[] p; p = nullptr; } }
//#endif
//
//#ifndef SAFE_RELEASE
template<typename ptr_t> void SAFE_RELEASE(ptr_t*& p) { if (p) { p->Release(); p = nullptr; } }
//#endif
