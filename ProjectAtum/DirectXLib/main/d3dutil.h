...
//       colors. It does not set emissive or specular colors.
//-----------------------------------------------------------------------------
VOID D3DUtil_InitMaterial( D3DMATERIAL9& mtrl, unsigned char r=0, unsigned char g=0,
...
public:
    // Access functions
    D3DXVECTOR3 GetEyePt() const			{ return m_vEyePt; }
    D3DXVECTOR3 GetLookatPt() const			{ return m_vLookatPt; }
    D3DXVECTOR3 GetUpVec() const			{ return m_vUpVec; }
    D3DXVECTOR3 GetViewDir() const			{ return m_vView; }
    D3DXVECTOR3 GetCross() const			{ return m_vCross; }
    ...
    D3DXMATRIX  GetBillboardMatrix() const	{ return m_matBillboard; }
    D3DXMATRIX  GetProjMatrix() const		{ return m_matProj; }

	void SetViewParams(const D3DXVECTOR3 &vEyePt, const D3DXVECTOR3& vLookatPt, const D3DXVECTOR3& vUpVec);
